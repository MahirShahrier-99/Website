...
function initKrobs() {
    ...
    $(".testimonials-holder .prev-slide-3").click(function() {
        f.trigger("owl.prev");
    });

    var h = $(".about-image-slider-3");
    h.owlCarousel({
        navigation: false,
        slideSpeed: 500,
        pagination: false,
    ...
    $(".about-image .next-slide-3").click(function() {
        h.trigger("owl.next");
    });
    $(".about-image .prev-slide-3").click(function() {
        h.trigger("owl.prev");
    });
    $('.clients-holder').css({
        height: $('.to-top-holder').outerHeight(true)
    });

        var f = $("#testimonials-slider-5");
    f.owlCarousel({
        navigation: false,
        slideSpeed: 500,
        pagination: false,
    ...
    $(".testimonials-holder .next-slide-5").click(function() {
        f.trigger("owl.next");
    });
    $(".testimonials-holder .prev-slide-5").click(function() {
        f.trigger("owl.prev");
    });

    var h = $(".about-image-slider-5");
    h.owlCarousel({
        navigation: false,
        slideSpeed: 500,
        pagination: false,
    ...
    $(".about-image .next-slide-5").click(function() {
        h.trigger("owl.next");
    });
    $(".about-image .prev-slide-5").click(function() {
        h.trigger("owl.prev");
    });
    $('.clients-holder').css({
        height: $('.to-top-holder').outerHeight(true)
    ...
    $(".testimonials-holder .next-slide-6").click(function() {
        f.trigger("owl.next");
    });
    $(".testimonials-holder .prev-slide-6").click(function() {
        f.trigger("owl.prev");
    });

    var h = $(".about-image-slider-6");
    h.owlCarousel({
        navigation: false,
        slideSpeed: 500,
        pagination: false,
        ...
        $(".testimonials-holder .next-slide-11").click(function() {
        f.trigger("owl.next");
    });
    $(".testimonials-holder .prev-slide-11").click(function() {
        f.trigger("owl.prev");
    });

    var h = $(".about-image-slider-11");
    h.owlCarousel({
        navigation: false,
        slideSpeed: 500,
        pagination: false,
    ...
    $(".about-image .next-slide-6").click(function() {
        h.trigger("owl.next");
    });
    $(".about-image .prev-slide-6").click(function() {
        h.trigger("owl.prev");
    });
        $(".about-image .next-slide-11").click(function() {
        h.trigger("owl.next");
    });
    $(".about-image .prev-slide-11").click(function() {
        h.trigger("owl.prev");
    });
    $('.clients-holder').css({
        height: $('.to-top-holder').outerHeight(true)
